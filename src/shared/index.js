...
if (!isDevClientInstance()) {
  ...
  function saveThreadId(threadId) {
    ...
    try {
      ...
      // Keep the thread ID in both storages so we can distinguish:
      // - a fresh session (clear old localStorage values)
      // - a page reload or popup reuse (preserve existing data)
      // - popup reloads preserve the active thread.
...
// // shared log
// console.log('Shared code is running. appears in all tenants.');
...
// // shared method, not invoked
// function sharedMethod1() {
//   console.log(`sharedMethod1() from shared code.`);
// }
// // shared method
// function sharedMethod2() {
//   console.log('sharedMethod2() executed in all tenants.');
// }
// sharedMethod2();
