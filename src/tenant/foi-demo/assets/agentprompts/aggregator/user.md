---
name: Aggregator user prompt for BC Freedom of Information request orchestrator
...
6. **No useful response.** If both agents fail to provide valid content — neither responds, both return `Not found` / `no match`, or the only available content is an error message — respond like "Please reframe your question or contact the Office of the Information and Privacy Commissioner (OIPC) for further assistance."
